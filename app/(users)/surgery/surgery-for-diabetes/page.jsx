            ...
            transition={{ duration: 0.8 }}>
              <div>
                ...
                <div className="mb-4">
                  ...
                  <p className='pt-2'>→ The results following bariatric and metabolic surgery are dramatic and fantastic. The diabetic medicines can be reduced or eliminated immediately or within a couple of weeks following surgery.</p>
                  <p className='pt-2'>→ The results typically persist for the rest of life, as long as average body weight is maintained.</p>
                  <p className='pt-2'>→ Complete cure or resolution of diabetes occurs in patients having a duration of diabetes less than five years and achieving and maintaining weight loss following bariatric surgery.</p>
                </div>
              </div>
            </motion.div>

...
export default function About() {
  return (
    <section className="relative rounded-3xl h-fit w-screen md:px-14 px-6 mb-16">
      ...
      <div className="icons absolute right-0">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1440" height="560" preserveAspectRatio="none" viewBox="0 0 1440 560">
          <g clipPath="url(&quot;#SvgjsClipPath1097&quot;)" fill="none">
            <circle r="93.335" cx="43.52" cy="-63.77" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="93.335" cx="382.88" cy="292" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="93.335" cx="826.88" cy="808.84" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="65.875" cx="1049.61" cy="454.07" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="133.805" cx="340.23" cy="350.04" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="102.41" cx="218.25" cy="441.49" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="145.655" cx="1099.49" cy="57.36" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="52.015" cx="190.27" cy="259.53" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="134.71" cx="426.91" cy="85.9" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="158.815" cx="145.75" cy="29.97" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="83.05" cx="633.67" cy="172.08" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
            <circle r="54.61" cx="717.14" cy="123.49" stroke="#365aa3" strokeOpacity="0.25" strokeWidth="2"></circle>
          </g>
          <defs>
      ...
      <div className='md:px-14 border-1 border-gray-500/20 border md:py-16 rounded-md shadow-md px-4 py-6 duration-200'>
        <motion.div

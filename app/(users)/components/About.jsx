...
export default function About() {
  return (
    <section className='rounded-3xl h-fit w-screen md:px-14 px-6 mb-16'>
      <div className='md:px-14 border-1 border-gray-500/20 border md:py-20 rounded-md md:shadow-lg shadow-md px-4 py-6 duration-200'>
        <motion.div
        ...
        <div className="content mt-12 md:flex gap-6 justify-between">
          <motion.div initial={{ opacity: 0, y: 100 }}
            ...
            <div className="img-txt md:mt-16 mt-5 text-md">

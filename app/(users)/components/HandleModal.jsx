...
function HandleModal() {
  ...
  return (
    <>
    <button type='button' onClick={()=> redirect('https://api.whatsapp.com/send?phone=+919999456455&text=Habilite%20Clinics.')} className='group fixed z-20 max-sm:hover:scale-105 transition-all duration-300 sm:bottom-28 bottom-20 right-6 sm:right-10 bg-[#25d366] flex items-center rounded-lg p-2 text-white sm:text-xl font-semibold' > 

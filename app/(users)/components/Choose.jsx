...
function Choose() {
  return (
    <section id="Choose" className="py-20 w-full">
      ...
      <div>
      <div className="md:px-36 px-10 relative md:flex-row flex-col min-h-[60vh] gap-8 grid md:grid-cols-3 grid-cols-1 justify-center overflow-hidden md:py-6">    <motion.div initial={{  opacity: 0 }}

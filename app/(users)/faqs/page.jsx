...
import { ChevronDownIcon, PinTopIcon } from '@radix-ui/react-icons';
...
function FAQ() {
  ...
  return (
    <div className='w-4/5 mx-auto px-4 py-10 flex flex-col justify-center items-center flex-wrap-reverse'>
      <motion.div
      ...
      <PinIcon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 text-first mr-1 sm:mr-2" />

        <h1 className='text-2xl sm:text-3xl md:text-4xl font-semibold text-second mb-2 text-center'>
          FAQs
        </h1>
      </div>
      </motion.div>
      <motion.div
        className="relative left-0 bottom-[-5px] h-[2px] bg-first mb-10"
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
          ...
          >
            ...
            >
              <div className="px-3 md:px-6 py-4 bg-gray-100">
                {/* Keep the inner HTML inside a paragraph to prevent width issues */}

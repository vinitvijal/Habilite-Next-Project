...
const Counter = ({ number, title }) => {
  return (
    <div className="number bg-neutral-100 p-10 rounded-lg flex flex-col gap-2 items-center">
      <span><CountUp duration={3} className="counter font-semibold text-5xl text-first/70" end={number} /><span className='text-5xl font-bold text-first/70'>+</span></span>
      <span className='text-lg text-neutral-800 font-medium'>{title}</span>
    </div>
  )
}

...
function Hospitals() {
  return (
    <section id='affiliations' className='w-screen md:px-28 px-12 justify-center items-center text-center flex-col'>
      <div className='justify-center items-center flex p-2 mb-6'>
        <h1 className='text-[#1463f3] font-bold text-4xl p-2'>AFFILIATIONS</h1>
      </div>
      <div className='grid 2xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 justify-center items-center md:px-20 px-2 lg:gap-12 gap-4 w-full'>

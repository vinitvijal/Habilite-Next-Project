...
function HandleModal() {
  ...
  return (
    <>
    {!showModal?<button className='group fixed z-20 max-sm:hover:scale-110 sm:bottom-10 bottom-6 right-6 sm:right-10 bg-first flex items-center rounded-lg p-2 text-white sm:text-xl font-semibold shadow-sm shadow-black ' onClick={()=>{setShowModal(true)}} >

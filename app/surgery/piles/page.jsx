  ...
  <Header/>
      ...
      <div className='w-screen'>
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-16 ">
          <div>
           ...
           Best Laser Piles Surgeon<br /> in Delhi</h1>
           </div>
           </div>
          </div>
       <div>
        ...
        {surgeonInfo.map((info, index) => (
          <div key={index} className="mb-8">
            ...
            <motion.p
              ...
              {info.description}
              <p className='text-second text-center m-4'>You can contact us on +91-9999456455, +91-9910024564</p>
           </motion.p>
          </div>
        ))}
      </div>
    ...
    <motion.div 
        ...
        <div>
         ...
         Internal piles can prolapse as the disease progress. They can be classified into 4 grades:</h2>
          <div className="mb-4">
          ...
          <h2 className="text-xl md:text-2xl mb-2 mt-3 text-black">
          Understanding the different types of piles is crucial for effective treatment and choosing the correct treatment modality.</h2>
         </div>
         </div>
      </motion.div>
   ...
   <motion.div 
     variants={imageVariants}
      ...
      <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-second text-center mb-4">BEST LASER PILES SURGERY IN DELHI</h2>
     <div className="mb-4">        
     <div>
         <h2 className="text-xl md:text-2xl font-semibold mb-2 text-first text-center">Medical or Non-Surgical Treatment for Piles:</h2>
      ...
      <div>
         <h2 className="text-xl md:text-2xl font-semibold mb-2 text-first text-center">Latest & Painless Treatment for Piles:</h2>
         <div className="mb-4 text-center">
    ...
    <motion.div 
           ...
           whileInView="visible"
           viewport={{ amount: 0.2 }}
           className="flex items-center justify-center grid grid-cols-1 md:grid-cols-1 max-w-6xl mx-auto">
           <div className="hover:bg-blue-200 p-12 border border-gray-300 border-2 hover:borounded-lg shadow-md">
           <div className="mb-4">
           ...
           <div
            key={index}
            className="bg-white p-12 border border-gray-300 border-2 hover:border-blue-500 text-center font-semibold py-3 px-5 rounded w-80 shadow-md" >
            {benefit}
          </div>
           ))}
         </div>
    ...
    <motion.div 
         ...
         <div className="relative w-full">
               ...
               src="/stapler.jpg"
               alt="Background"
               className="w-[80vh] opacity-200"/> </div>
            <br />              
         <div>
         ...
         <div className="mb-4">
          ...
          <motion.div initial={{ opacity: -2 }} 
           ...
           <motion.div 
              ...
              transition={{ duration: 0.8 }}>
              <h2 className="text-2xl md:text-3xl font-semibold mb-2 mt-3 text-first">
              Why Choose Us - Best Hospital for Piles Treatment in Delhi</h2>
              <div className="mb-4">

         ...
         <div>
             ...
             <div className="flex flex-col mx-auto px-8 md:px-16 lg:px-24 gap-10">
                   ...
                   <motion.div 
                          ...
                          className=''>
                          <h1 className="text-2xl md:text-3xl font-semibold mb-2 text-first">About Dr Kapil Agrawal</h1>
                          <div className="mb-4">
                    ...
                    <div className='flex-col mb-8'>
                       ...
                       <br />
                         ...
                         <motion.div 
                          ...
                          Laser Surgery For Anal Fistula</h2>
                          <div className="mb-4">
                          ...
                          <div className='flex-col items-center justify-center mx-auto gap-20 my-8'>
                            <div className="text-center mb-20">
                             ...
                             <div className="hover:bg-blue-200 p-12 border border-gray-300 border-2 hover:border-blue-500 rounded-lg shadow-md">
                             <div className="mb-4">
                        ...
                        <motion.div 
                          ...
                          transition={{ duration: 0.8 }}>
                          <div>
                          <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-first">VAAFT Procedure (Video-Assisted Anal Fistula Treatment)
                          </h2>
                          <div className="mb-4">
                          ...
                          <br />
                            ...
                            <div>
                          <h2 className="text-2xl md:text-3xl font-semibold mb-2 mt-3 text-first">
                          LIFT (Ligation of Inter sphincteric Fistula Tract)</h2>
                          <div className="mb-4">

      ...
      <div className='w-screen'>
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-16 ">
          <div>
           ...
           Best Lipoma Treatment<br /> in Delhi</h1>
           </div>
           </div>
          </div>
       <div>
      ...
      <div className="py-8 mt-16 mb-8 text-center border-t-2 border-b-2 border-first">
       ...
       <motion.div 
        ...
        <motion.div 
           ...
           viewport={{ amount: 0.2 }}>
           <div className='mt-4'>
           <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-first text-center">Best Treatment Options for Lipoma</h2>
           <div className="mb-4">
             ...
             <p className='pt-2 ml-5'>superficial, small and soft in consistency. The main advantage of liposuction is minimally invasive procedure resulting in rapid recovery and better cosmetic outcomes in aesthetically sensitive areas like face or neck.</p>
             <p className='pt-2 ml-5'> The major limitation of this procedure is its non-suitability for deep lipomas, large lipomas or lipomas near blood vessels or nerves. Sometimes, liposuction may result in incomplete removal of lipomas resulting in recurrence.</p>
             ...
             <p className='pt-2 ml-5'>case of lipomas and has least complication rates. The procedure involves use of highly specialized instruments to elevate the lipoma from underlying tissues. A sharp tool is then introduced to cut around base of lipoma and remove it from underlying tissues.</p>
             <p className='pt-2 ml-5'>The wound is then allowed to heal on its own. This technique is not used for very large and deep lipomas.</p>
             ...
             <p className='pt-2 ml-5'> resulting in recurrence of lipomas. Laser therapy works by delivering focused light energy that is absorbed by the fat cells within the lipoma. This absorption generates heat, which leads to thermal damage and subsequent breakdown of the fat cells. However, hard lipomas and large lipomas may not completely break down resulting in recurrences.</p>
             <p className='pt-2 ml-5'>The effectiveness of laser therapy for lipomas can vary depending on the size, location, and characteristics of the lipoma. Small, superficial lipomas may respond well to laser treatment, whereas larger or deeper lipomas may require alternative or adjunctive treatments.</p>
             ...
             <p className='pt-2 ml-5'>sessions, incomplete removal of lipomas and higher recurrences.They are not considered a definitive cure and may need to be repeated periodically for sustained benefit.</p>
           </div>
           </div>
          </motion.div>

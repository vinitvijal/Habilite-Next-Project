...
function Blog() {
  ...
  return (
    <>
      ...
      <div className="title mt-24 flex ml-32 items-end gap-3">
        <p className="text-8xl ">Blogs</p>
        <p className="text-first text-lg font-light">Insights and experiences to inspire better health.</p>
      </div>


      <div className="categories mt-20 ml-32 text-2xl flex gap-7 items-center">
        <p className="mb-1 flex items-center"><svg className="mr-1 mt-1 text-second" width="22" height="22" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.14921 3.99996C2.14921 2.97778 2.97784 2.14915 4.00002 2.14915C5.02219 2.14915 5.85083 2.97778 5.85083 3.99996C5.85083 5.02213 5.02219 5.85077 4.00002 5.85077C2.97784 5.85077 2.14921 5.02213 2.14921 3.99996ZM4.00002 1.24915C2.48079 1.24915 1.24921 2.48073 1.24921 3.99996C1.24921 5.51919 2.48079 6.75077 4.00002 6.75077C5.51925 6.75077 6.75083 5.51919 6.75083 3.99996C6.75083 2.48073 5.51925 1.24915 4.00002 1.24915ZM5.82034 11.0001L2.49998 12.8369V9.16331L5.82034 11.0001ZM2.63883 8.21159C2.17228 7.9535 1.59998 8.29093 1.59998 8.82411V13.1761C1.59998 13.7093 2.17228 14.0467 2.63883 13.7886L6.57235 11.6126C7.05389 11.3462 7.05389 10.654 6.57235 10.3876L2.63883 8.21159ZM8.30001 9.00003C8.30001 8.61343 8.61341 8.30003 9.00001 8.30003H13C13.3866 8.30003 13.7 8.61343 13.7 9.00003V13C13.7 13.3866 13.3866 13.7 13 13.7H9.00001C8.61341 13.7 8.30001 13.3866 8.30001 13V9.00003ZM9.20001 9.20003V12.8H12.8V9.20003H9.20001ZM13.4432 2.19311C13.6189 2.01737 13.6189 1.73245 13.4432 1.55671C13.2675 1.38098 12.9826 1.38098 12.8068 1.55671L11 3.36353L9.19321 1.55674C9.01748 1.381 8.73255 1.381 8.55682 1.55674C8.38108 1.73247 8.38108 2.0174 8.55682 2.19313L10.3636 3.99992L8.55682 5.80671C8.38108 5.98245 8.38108 6.26737 8.55682 6.44311C8.73255 6.61885 9.01748 6.61885 9.19321 6.44311L11 4.63632L12.8068 6.44314C12.9826 6.61887 13.2675 6.61887 13.4432 6.44314C13.6189 6.2674 13.6189 5.98247 13.4432 5.80674L11.6364 3.99992L13.4432 2.19311Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg>Categories  <svg className="mt-1 ml-5" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.14645 3.14645C8.34171 2.95118 8.65829 2.95118 8.85355 3.14645L12.8536 7.14645C13.0488 7.34171 13.0488 7.65829 12.8536 7.85355L8.85355 11.8536C8.65829 12.0488 8.34171 12.0488 8.14645 11.8536C7.95118 11.6583 7.95118 11.3417 8.14645 11.1464L11.2929 8H2.5C2.22386 8 2 7.77614 2 7.5C2 7.22386 2.22386 7 2.5 7H11.2929L8.14645 3.85355C7.95118 3.65829 7.95118 3.34171 8.14645 3.14645Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg></p>
        <div className="pills text-sm flex gap-2 items-center">
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Bariatric Surgery</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Gall Bladder Stone</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Hernia</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Laparoscopic Surgery</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Lipoma</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Non-Surgical Weight Loss</p>
          <p className="text-second px-3 py-1 rounded-lg bg-[#a1bef534] hover:bg-[#a1bef593] cursor-pointer active:bg-[#7a9ee0fe] border-[1px] border-first">Piles</p>
        </div>
      </div>


      <div className="featured ml-32 mt-28">
        ...
        <div className="boxes mt-10 mr-24">
          {featured1 && (
            <Link href={`/blogs/${featured1.slug}`}>
              <div className="first-featured h-[70vh] group bg-cover bg-center border-t-4 border-first rounded-lg relative hover:border-2 hover:border-first hover:scale-[101%] cursor-pointer transition-all duration-300 box-border hover:shadow-xl" style={{ backgroundImage: `url(${featured1.blogImage})` }}>
                ...
                <div className="content z-20 mt-auto duration-300">
                  ...
                  <div className="lower-content absolute bottom-7 left-6 z-20 pr-6 text-white">
                    ...
                    <p className="text-4xl mb-2 font-semibold">{featured1.title}</p>
          ...
          <div className="below-2-boxes flex gap-2 mt-3">
            {featured.slice(1).map(blog => {
              return (
                <div className="box w-1/2 h-[40vh] border-first rounded-lg border-t-4 relative bg-cover bg-center hover:border-2 hover:border-first hover:scale-[101%] cursor-pointer transition-all duration-300 box-border hover:shadow-xl" style={{ backgroundImage: `url(${blog.blogImage})`}}>
                  <div className="overlay inset-0 z-10 bg-gradient-to-b from-transparent absolute to-[#00000aad] rounded-lg duration-300"></div>
                  ...
                  <div className="content z-20 mt-auto duration-300">
                    ...
                    <div className="lower-content absolute bottom-7 left-6 z-20 right-7 text-white">
                      <p className="date text-sm">{blog.date}</p>
                      <p className="text-lg mb-2 font-semibold">{truncateText(blog.title, 8)}</p>

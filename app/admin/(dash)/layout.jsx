  ...
  return (
    <main className=" h-screen w-screen flex">
      <aside className=" left-0 top-0 z-40 h-screen w-64 border-r bg-primary text-primary-foreground">
        ...
        <nav className="space-y-1 px-3 py-4 flex flex-col ">
          {[
            ...
            <Link href={path}>
              <Button
                ...
                variant="ghost"
                className={cn(
                  "w-full justify-start gap-3 text-primary-foreground/80 hover:text-primary",
                  pathname === path && "text-primary bg-primary-foreground/70"
                )}
              >
      ...
      <div className=" h-screen p-4 flex-1">{children}</div>
    </main>
  );
}
